...
print(vendingMachine.buy(foodName: "페퍼로니피자", restaurant: "피자헛"))
print(vendingMachine.checkPurchaseList())
print(vendingMachine.checkAblePurchase(money: 30000))
print(vendingMachine.buy(foodName: "양념치킨", restaurant: "교촌치킨"))
print(vendingMachine.checkPurchaseList())
print(vendingMachine.checkAblePurchase(money: 50000))
print(vendingMachine.buy(foodName: "양념치킨", restaurant: "교촌치킨"))
print(vendingMachine.buy(foodName: "콤비네이션", restaurant: "피자헛"))
print(vendingMachine.checkPurchaseList())
